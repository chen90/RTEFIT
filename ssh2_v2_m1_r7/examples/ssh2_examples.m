...
addpath('E:\Magnetic_diagnostic\22turnCase\RTEFIT\ssh2_v2_m1_r7');
RTEFIT_path='/home/chenbin/efitj6_enn_1plasma/RTEFIT';
%% SIMPLE CONNECTION
% Basic Connection: to make a simple, one-time use, connection.
command_output = ssh2_simple_command('10.1.141.210','chenbin','Lhping*520',['cd ',RTEFIT_path,'&& ./runefit']);
