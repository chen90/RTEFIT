function [info,picture,t]=downloadcine(shotnum,t1,t2,dframe,camera)
...
switch nargin
    case 1
        t1=0;t2=Inf;dframe=1; camera='M120';
    case 2
        t2=Inf; dframe=1;camera='M120';
    case 3
        dframe=1;camera='M120';
    case 4
        camera='M120';
    case 5
        if camera=='1'
...
switch info.RealBPP
    ...
    k=1;
    nums=length(frm_min:dframe:frm_max);
    picture=zeros(nums,info.Height,info.Width);
    if frm_min<=0
    frm_min=1;
    end
    ...
    t=times(frm_min:dframe:frm_max)-dt;
    fclose(fid);
